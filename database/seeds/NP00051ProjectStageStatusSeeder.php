...
class NP00051ProjectStageStatusSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        if( \App\Module::where('key', $module_key)->count() == 0) {
            \App\Module::create([
                'key' => $module_key,
                'name' => 'Estados de etapa de proyecto',
                'url' => 'project_stage_statuses',
                'help' => 'help/project_stage_statuses'
            ]);
        }
