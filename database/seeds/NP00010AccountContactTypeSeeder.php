...
class NP00010AccountContactTypeSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        \App\Module::create([
            'key' => $module_key,
            'name' => 'Cuentas / Formas de contacto',
            'url' => 'account_contact_types',
            'help' => 'help/account_contact_types'
        ]);
                    ...
                    [
                        ...
                        'fields' => [
                            [
                                ...
                                'default' => null,
                                'options' => null,
                                'validations_create' => 'required|exists:accounts,id',
                                'validations_update' => 'required|exists:accounts,id',
                                'is_simple_form' => true
                            ],
                            [
                                'field_type_id' => 2,
